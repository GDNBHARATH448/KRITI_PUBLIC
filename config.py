...
API_ID = int(getenv("API_ID","32139829"))
API_HASH = getenv("API_HASH","02dcdb860693174d18d2a5eaf1dc8d77")

BOT_TOKEN = getenv("BOT_TOKEN")
OWNER_USERNAME = getenv("OWNER_USERNAME","@Likith8123")
BOT_USERNAME = getenv("BOT_USERNAME" , "@likimusicbot")
BOT_NAME = getenv("BOT_NAME" , "˹𝙇𝙞𝙠𝙞𝙢𝙪𝙨𝙞𝙘𝙗𝙤𝙩˼ 🫧")
ASSUSERNAME = getenv("ASSUSERNAME" , "ALPHA")
MONGO_DB_URI = getenv("MONGO_DB_URI", None)
DURATION_LIMIT_MIN = int(getenv("DURATION_LIMIT", 17000))
LOGGER_ID = int(getenv("LOGGER_ID", -1003360162133))
OWNER_ID = int(getenv("OWNER_ID", 7946875913))
HEROKU_APP_NAME = getenv("HEROKU_APP_NAME")
HEROKU_API_KEY = getenv("HEROKU_API_KEY")
UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/GDNBHARATH448/KRITI_PUBLIC",)
